...
## Project Structure
    ...
    ├── mansa_market_watch_36819  # Django project configurations
...
1. Clone this repo and `cd mansa_market_watch_36819`
...
2. Clone this repo and `cd mansa_market_watch_36819`
